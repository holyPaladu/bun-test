...
/** Auth JWKS недоступен при обязательном обновлении ключей. */
export class AuthVerificationUnavailableError extends AppError {
  readonly code = 'AUTH_VERIFICATION_UNAVAILABLE'
  readonly status = 503

  constructor() {
    super('Authentication verification is temporarily unavailable')
  }
}
